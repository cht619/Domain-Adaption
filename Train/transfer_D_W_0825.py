#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2020/8/25 14:33
# @Author  : CHT
# @Blog    : https://www.zhihu.com/people/xia-gan-yi-dan-chen-hao-tian
# @Site    : 
# @File    : transfer_D_W.py
# @Function: D->W
# @Software: PyCharm
import numpy as np
import torch
...
def train_generate_samples(discriminator, classifier, dataloader_src, dataloader_tgt, train_epochs, domain_label,
    ...
    迭代100次后开始生成图片
    """
    os.makedirs('../generate_samples/D_W', exist_ok=True)
    ...
    for epoch in range(train_epochs[0]):
        ...
        if epoch >= save_samples_epoch:
            ...
            save_image(generate_imgs, '../generate_samples/D_W/{}.png'.format(epoch), nrow=20, normalize=True)
...
if __name__ == '__main__':
    ...
    train_generate_samples(discriminator, classifier, dslr_dataloader, webcam_dataloader, train_epochs, domain_label,
                           loss_weight, save_samples_epoch)
